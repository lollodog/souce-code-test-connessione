...
if exist "C:\Users\%username%\AppData\Local\test connessione\testa connessione.exe" (goto verify) else (goto collegamanto)
...
:no
md "C:\Users\%username%\AppData\Local\Google\lollo"
cd "C:\Users\%username%\AppData\Local\Google\lollo"
...
echo =======================================================
echo.
echo premi "8" per avviare questo programma all avvio del pc
echo.
echo premi "9" non avviare questo programma all avvio del pc
echo.
echo =======================================================
echo.
...
if %errorlevel%==8 goto startup
if %errorlevel%==9 goto removestartup
...
echo.
echo posizione file di memoria (.inf) in: "C:\Users\%username%\AppData\Local\Google\lollo"
echo.
...
echo.
echo aggiunta possibilita di far avviare il programma all avvio del pc
echo.
echo in arrivo !!!
echo.
echo in arrivo !!!
...
:import
cls
echo premi invio senza digitare niente per selezionare la cartella desktop
echo.
echo                                 nota bene !!!
echo.
...
xcopy "C:\Users\%username%\AppData\Local\test connessione\testa connessione.exe"  "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup" /Q /Y >nul
goto inizio

:removestartup

del "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\testa connessione.exe" \q
goto inizio
